...
function Main(){
    ...
    <nav>
      <div className="flex-nav">
        ...
        <div className="nav-profile">
          <button className="nav-button"><img src="/images/profile.png" alt="profile-img" className="img" /></button>          
          <div className="nav-menu bubble show">
            <div className="menu">
              <p><i className="fa-regular fa-user"></i>&nbsp;&nbsp;&nbsp;프로필</p>
              <p><i className="fa-regular fa-bookmark"></i>&nbsp;&nbsp;&nbsp;저장됨</p>
              <p><i className="fa-solid fa-gear"></i>&nbsp;&nbsp;&nbsp;설정</p>
            </div>
    ...
    <main>
      <div className="main-left">
        ...
        <div className="fed-content">
          ...
          <div className="content-like">
            ...
            <div><span>Awer</span>님 외<span>10</span>명이 좋아합니다</div>
          </div>
          ...
          <div className="content-reply">
            <div className="template">
                <p>jaewing 가나다라마바사</p>
                <div>
                <button className="setting-reply heart"><i className="fa-solid fa-heart"></i></button> 
          ...
          <p className="time"><span>42</span>분 전</p>
        </div>
      ...
      <div className="main-right">
        ...
        <div className="infor">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde odit, pariatur adipisci exercitationem dolores eum reiciendis vel aliquam porro totam doloremque voluptatem temporibus incidunt blanditiis velit animi? Totam, sit eius.</p>
        </div>
      </div>
    </main>
       </> 
